...
<body class="sidebar-fixed sidebar-dark header-light header-fixed" id="body">
  ...
  <div class="wrapper">
    ...
    <aside class="left-sidebar bg-sidebar">
      ...
      <li class="has-sub">
        <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#opciones"
        aria-expanded="false" aria-controls="dashboard">
        <i class="mdi mdi-cube-outline"></i>
        <span class="nav-text">Opciones</span> <b class="caret"></b>
      </a>
      <ul class="collapse" id="opciones" data-parent="#sidebar-menu">
        <div class="sub-menu">
