                                ...
                                foreach ($users as $user) {
                                    ...
                                    <tr>
                                        <td style="text-align: center;">
                                            ...
                                            <button id="btnDeleteUser" class="btn btn-danger btn-delete-user" data-original-title="Borrar usuario" data-toggle="tooltip" data-id-user="<?= $user['ID_USUARIO'] ?>" style=" padding: 2px 5px !important;">
...
<div class="modal fade" id="modDelUser" tabindex="-1" role="dialog" aria-labelledby="modCustomer" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body text-center" id="modBodyDelUser"></div>
            <div class="clear"></div>
