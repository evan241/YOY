                                ...
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" style="text-transform:uppercase;" name="RG_NOMBRE_USUARIO" required id="RG_NOMBRE_USUARIO" class="form-control" placeholder="Nombre del usuario" >
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>      
                                    <div class="col-md-12">
                                        <div class="form-group"> 
                                            <label for="RG_APELLIDOS_USUARIO" class="control-label text-left">Apellido</label>
                                ...
                                <div class="panel-body">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" style="text-transform:uppercase;" name="RG_USERNAME_USUARIO" id="RG_USERNAME_USUARIO" class="form-control" placeholder="username">
                                             <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="RG_PASSWORD_USUARIO" id="RG_PASSWORD_USUARIO" required class="form-control" placeholder="password">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                </div>
