                  ...
                  <tr style="border-collapse:collapse;">
                     <td align="center" style="padding:0;Margin:0;">
                        <table class="es-header-body"
                           style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#4caf50;"
                           width="600" cellspacing="0" cellpadding="0" bgcolor="#4caf50" align="center">
                           <tr style="border-collapse:collapse;">
                              <td align="left"
                                             ...
                                             <tr style="border-collapse:collapse;">
                                                <td align="center" style="padding:0;Margin:0;padding-bottom:5px;">
                                                   <table width="100%" height="100%" cellspacing="0" cellpadding="0"
                                                      ...
                                                      <tr style="border-collapse:collapse;">
                                                         <td
                                                            style="padding:0;Margin:0px;border-bottom:1px solid #4caf50;background:rgba(0, 0, 0, 0) none repeat scroll 0% 0%;height:1px;width:100%;margin:0px;">
                                                         </td>
                                                      </tr>
                                                   </table>
                                                </td>
                                                   ...
                                                   <table cellspacing="0" cellpadding="0" align="right"
                                                      ...
                                                      <tr style="border-collapse:collapse;">
                                                         ...
                                                         <td valign="top" align="left"
                                                            style="padding:0;Margin:0;padding-left:10px;"><a
                                                               href="#" target="_blank"
                                                ...
                                                <td align="center"
                                                   ...
                                                   <a target="_blank" href="#"
                                                      style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:15px;text-decoration:none;color:#ED8E20;"><img
                                                         src="https://ezfjoq.stripocdn.email/content/guids/CABINET_29a5d0104c74e3efc31f80363e7852fd/images/69621582530278727.png"
                                                         alt
                                                         style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;"
                                                         width="120"></a></td>
                                             </tr>
                                             ...
                                             <tr style="border-collapse:collapse;">
                                                <td align="center"
                                                   ...
                                                   <p
                                                      ...
                                                      Tu compra está en proceso de verificación. Esto puede tardar<br>
                                                      de 1 a 24&nbsp;horas, agradecemos tu paciencia.</p>
                                                </td>
                                             </tr>
                                             <tr style="border-collapse:collapse;">
                                                <td align="center"
                                                   ...
                                                   <table width="100%" height="100%" cellspacing="0" cellpadding="0"
                                                      ...
                                                      <tr style="border-collapse:collapse;">
                                                         <td
                                                            style="padding:0;Margin:0px;border-bottom:3px solid #EEEEEE;background:rgba(0, 0, 0, 0) none repeat scroll 0% 0%;height:1px;width:100%;margin:0px;">
                                                         </td>
                                                      </tr>
                                                   </table>
                                                </td>
                                             ...
                                             <tr style="border-collapse:collapse;">
                                                <td align="center"style="padding:0;Margin:0;padding-bottom:15px;padding-top:20px;">
                                                   <table width="100%" height="100%" cellspacing="0" cellpadding="0"border="0" role="presentation"style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                                      ...
                                                      <tr style="border-collapse:collapse;">                                                        
                                                         <td style="padding:5px !important;font-family: 'open sans','helvetica neue',helvetica,arial,sans-serif;padding:0;Margin:0px;border-bottom:3px solid #EEEEEE;background:rgba(0, 0, 0, 0) none repeat scroll 0% 0%;height:1px;width:100%;margin:0px;">
                                                         </td>     
                                                         <td style="padding:5px !important;font-family: 'open sans','helvetica neue',helvetica,arial,sans-serif;padding:0;Margin:0px;border-bottom:3px solid #EEEEEE;background:rgba(0, 0, 0, 0) none repeat scroll 0% 0%;height:1px;width:100%;margin:0px;">
                                                         </td>                                                     
                                                         <td style="padding:5px !important;font-family: 'open sans','helvetica neue',helvetica,arial,sans-serif;padding:0;Margin:0px;border-bottom:3px solid #EEEEEE;background:rgba(0, 0, 0, 0) none repeat scroll 0% 0%;height:1px;width:100%;margin:0px;">
                                                      ...
                                                      <tr style="border-collapse:collapse;">
                                                         <td style="font-family: 'open sans','helvetica neue',helvetica,arial,sans-serif;padding:5px;Margin:0px;border-bottom:3px solid #EEEEEE;background:rgba(0, 0, 0, 0) none repeat scroll 0% 0%;height:1px;width:100%;margin:0px;">
                                                           TOTAL
                                                         </td>
                                                         <td style="font-family: 'open sans','helvetica neue',helvetica,arial,sans-serif;padding:0;Margin:0px;border-bottom:3px solid #EEEEEE;background:rgba(0, 0, 0, 0) none repeat scroll 0% 0%;height:1px;width:100%;margin:0px;">
