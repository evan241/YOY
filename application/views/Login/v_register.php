        ...
        <div class="container-fluid">
            <div class="row" id="pwd-container">
                ...
                <div class="col-sm-4"><br><br>
                    <form  name="form" autocomplete="off" autocomplete="nope">
                    <section class="login-form">
                        <img src="<?php echo base_url(); ?>assets/img/logo_rolling2.png" class="img-responsive center-block" alt="Logo GNP" />
                        <label class="label-control text-center"><h3>Bienvenido</h3></label>
                        <input type="text" autocomplete="off" autocomplete="nope" name="RG_USERNAME_USUARIO" id="RG_USERNAME_USUARIO" placeholder="Usuario" required class="form-control input-lg" style=" height: 60px;" value="" />
                        <input type="password" autocomplete="off" autocomplete="nope"  class="form-control input-lg" id="RG_PASSWD_USUARIO" name="RG_PASSWD_USUARIO" required style=" height: 60px;" placeholder="Password" value="" />
